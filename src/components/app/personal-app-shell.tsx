...
const navigationGroups = [
  {
    items: [
      { href: "/dashboard", icon: IconLayoutDashboard, label: "Painel" },
        ...
        {mobileNavigation.map(({ href, icon: Icon, label }) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex min-h-11 min-w-11 flex-1 items-center justify-center gap-2 rounded-lg px-2 py-2 text-xs font-semibold sm:text-sm",
                focus,
